...
if lIIIlIIIlllllllllI == 'สร้างเมนูจากวัตถุดิบ':
    ...
    with lIIIIlllIlIIll('⚙️ ตั้งค่าการค้นหา', expanded=lllllllllllllII(((1 & 0 ^ 0) & 0 ^ 1) & 0 ^ 1 ^ 1 ^ 0 | 1)):
        (IIlIllIlIlIIIIlIlI, IIlllllllIlIlllIll) = lllIlIIlIllIlI(2)
        with IIlIllIlIlIIIIlIlI:
            llIlIlllIIlIlIllIl = IlIIlIllIlIIll('ประเทศ', ['ไทย', 'ญี่ปุ่น', 'เกาหลีใต้', 'สหรัฐอเมริกา', 'อังกฤษ', 'ฝรั่งเศส', 'เยอรมนี'])
            IIllllllllIIIIIlII = IlIIlIllIlIIll('ประเภทอาหาร', ['อาหารไทย', 'อาหารญี่ปุ่น', 'อาหารเกาหลี', 'ฟาสต์ฟู้ด', 'อาหารสุขภาพ'])
        with IIlllllllIlIlllIll:
            lIlllIllIIIIIIllll = lIIIIIIllIlIll('รสชาติ', ['เผ็ด', 'หวาน', 'เค็ม', 'เปรี้ยว'], horizontal=lllllllllllllII(((1 & 0 ^ 0) & 0 ^ 1) & 0 ^ 1 ^ 1 ^ 0 | 1))
            IIlllllIIlIIIlIlll = lIIIIIIllIlIll('งบประมาณ', ['ต่ำกว่า 100 บาท', '100 - 300 บาท', 'มากกว่า 300 บาท'], horizontal=lllllllllllllII(((1 & 0 ^ 0) & 0 ^ 1) & 0 ^ 1 ^ 1 ^ 0 | 1))
    if IIIlIlIIIIIllI('🔎 ค้นหาเมนู', use_container_width=lllllllllllllII(((1 & 0 ^ 0) & 0 ^ 1) & 0 ^ 1 ^ 1 ^ 0 | 1)):
        lIIIlIIIllIlIlIllI = f"ฉันต้องการซื้ออาหาร {IIllllllllIIIIIlII} รสชาติ {lIlllIllIIIIIIllll} งบประมาณ {IIlllllIIlIIIlIlll} ใน {llIlIlllIIlIlIllIl} แนะนำ 3 ตัวเลือกเมนู {IIllllllllIIIIIlII} ที่มีขายใน {llIlIlllIIlIlIllIl} คั่นด้วย '🍽️ เมนูที่'"
